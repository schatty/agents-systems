...
class Agent:
    ...
    def __init__(self, sess, env, seed, n_agent=0):
        print(f"Initialializing agent {n_agent}...")
    ...
    def build_summaries(self, logdir):
        ...
        # Initialize reward var - this will not be initialized with the other network variables as these are copied from learner
    ...
    def run(self, PER_memory, gaussian_noise, run_agent_event, stop_agent_event):
        ...
        # Initialize var for logging episode reward
    ...
    def test(self):
        ...
        if test_params.RESULTS_DIR is not None:
            if not os.path.exists(test_params.RESTLTS_DIR):
