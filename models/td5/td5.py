...
class LearnerTD5(object):
    ...
    def _update_step(self, batch, replay_priority_queue, update_step):
        ...
        target_value_1, target_value_2 = self.target_value_net.get_probs(next_state, next_action.detach())
        ...
        current_Q1, current_Q2 = self.value_net.get_probs(state, action)
        ...
        if self.total_it % self.policy_freq == 0:
            policy_loss = self.value_net.Q1(state, self.policy_net(state))
